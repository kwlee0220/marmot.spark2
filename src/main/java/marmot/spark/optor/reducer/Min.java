 ...
 */
public class Min implements ValueAggregator<Min> {
	...
	public Min(String colName, String outColName) {
		m_colName = colName;
	...
	@Override
	public Min as(String outColName) {
		m_outColName = outColName;
		return this;
	}
	...
	public void collect(RecordLite accum, RecordLite input) {
		Object min = accum.get(m_outputColIdx);
		Object data = input.get(m_inputCol.ordinal());
		if ( min == null || m_cmptor.compare(min, data) > 0 ) {
